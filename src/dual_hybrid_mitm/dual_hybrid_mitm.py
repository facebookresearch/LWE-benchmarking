...
def get_parser():
    ...
    parser.add_argument("--secret_path", type=str, default=None,
    ...
    parser.add_argument("--float_type", type=str, default="qd",
    ...
    # BKZ/LLL/Flatter specific params
    ...
    parser.add_argument("--bkz_block_size", type=int, default=30,
                        help="Starting block size of the BKZ reduction")
    parser.add_argument("--alpha", type=float, default=0.04,
                        help="Alpha param for flatter reduction")
...
if __name__ == '__main__':
    ...
    if params.step == 'reduce':
        assert params.N > 0 and params.Q > 0 and params.hamming > 0, "Need to provide N, Q, and hamming weight to run reduction."
    else: # MITM
        try:
        ...
        # Can't change Hamming weight too much, since this is how params.scale is set. 
        ...
        # Set the secret path if provided.
        if params.secret_path is not None:
    ...
    params.rand_rows = False # dummy for interleaved reduction
    main(params)
